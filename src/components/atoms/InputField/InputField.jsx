...
const Input = styled.input`
  ...
  &:focus:not(:disabled) {
    background:
      linear-gradient(${({ theme }) => theme.colors.backgroundLowEmphasis}, ${({ theme }) =>
    theme.colors.backgroundLowEmphasis}) padding-box,
      linear-gradient(93.46deg, ${({ theme }) => theme.colors.primaryHighEmphasis} 16.94%, ${({
    theme,
  ...
  &:hover {
    background:
      linear-gradient(${({ theme }) => theme.colors.backgroundLowEmphasis}, ${({ theme }) =>
    theme.colors.backgroundLowEmphasis}) padding-box,
      linear-gradient(93.46deg, ${({ theme }) => theme.colors.primary500} 16.94%, ${({ theme }) =>
