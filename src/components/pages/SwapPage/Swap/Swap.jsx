    ...
    <>
      <div className="swap_box">
        <div className="swap_box_top">
          ...
          <SwapSwapInput balances={balances} currencies={currencies} value={swapDetails} onChange={setSwapDetails} />
      ...
      {user.address ? (
        <div className="swap_connected_as">
          <span className="swap_bubble_connected" />
          {' '}Connected as {`${user.address.substr(0, 6)}...${user.address.substr(-5)}`}
          <span onClick={disconnect} className="swap_disconnect">{' • '}<a href="#disconnect">Disconnect</a></span>
        </div>
      ) : (
        <div className="swap_connected_as">
