      ...
      <div className="bridge_section">
        <div className="bridge_container">
          <div className="bridge_head_tabs">
            <Link className={cx({ 'bridge_head_tab_active': tab === 'bridge' })} to="/bridge">Bridge</Link>
            <Link className={cx({ 'bridge_head_tab_active': tab === 'receipts' })} to="/bridge/receipts">Receipts</Link>
          </div>
        </div>
