...
import { NETWORKS, ZKSYNC_ETHEREUM_FAST_BRIDGE, ZKSYNC_POLYGON_BRIDGE } from './constants';
...
const BridgeContainer = () => {
    ...
    useEffect(() => {
        ...
        const getCurrencyBalance = (cur) =>
            balances[cur] && balances[cur].valueReadable ? balances[cur].valueReadable : 0;
        ...
        if (feeCurrencyInfo && feeCurrencyInfo.decimals) {
            ...
            const feeTokenBalance = parseFloat(
                balances[L2FeeToken] && balances[L2FeeToken].value / 10 ** feeCurrencyInfo.decimals,
            );
