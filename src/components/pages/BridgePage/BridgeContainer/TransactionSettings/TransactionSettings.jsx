                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <QuestionHelper
                                            text={
                                                <x.div>
                                                    <x.div mb={2}>
                                                        Fast: receive ETH, UST and FRAX within
                                                        seconds through ZigZag's Fast Withdrawal
                                                        bridge.
                                                    </x.div>
                                                    <x.div mb={2}>
                                                        Normal: use zkSync's bridge and receive
                                                        funds after a few hours.
                                                    </x.div>
                                                </x.div>
                                            }
                                            placement="bottom"
            ...
            {transfer.type === 'deposit' && user.address && !user.id && (
                <div className="flex justify-between mt-4">
                    <div className="flex space-x-2">
                        <div>
                            <p className="font-sans text-sm ">One-time Account Activation fee:</p>
