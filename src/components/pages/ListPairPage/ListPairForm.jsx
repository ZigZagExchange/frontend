    ...
    return (
        <ListPairContainer>
            ...
            >
                            ...
                            rightOfLabel={
                                <QuestionHelper
                                    text={
                                        <>
                                            <x.div>
                                                Number of decimal places in the price of the asset
                                                pair.
                                            </x.div>
                ...
                <x.div h={'1px'} w={'full'} bg={'blue-gray-800'} borderRadius={10} mb={21} />
                                ...
                                rightOfLabel={
                                    <QuestionHelper
                                        text={
                                            <div>
                                                <x.div>
                                                    Default TradingView chart to be seen on the
                                                    trade page
                                                </x.div>
                                                <x.div mt={2}>
...
const PairPreview = ({ baseAssetId, quoteAssetId, baseSymbol, quoteSymbol }) => {
    const isMobile = window.innerWidth < 500;
    return (
        <>
            {(baseAssetId || quoteAssetId) && (
                ...
                >
                    ...
                    <x.span color={baseSymbol && quoteSymbol ? 'blue-gray-400' : 'blue-gray-800'}>
                        /
                    </x.span>
