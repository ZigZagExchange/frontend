...
const TransactionSettings = ({
    ...
    return (
        <div className="p-4 mt-4 border-t border-b border-l border-r rounded-lg dark:border-foreground-400 border-primary-500">
                    ...
                    <QuestionHelper
                        text={
                            <div>
                                ...
                                <p>
                                    Unfilled orders remain open for 60 seconds and are automatically
                                    closed after.
                                </p>
                            </div>
                        }
            ...
            <div className="flex justify-between mt-4">
                <p className="flex items-center gap-2 text-base font-light ">Estimated gas fee</p>
                <div className="flex items-center gap-2 text-base ">
                    {`${formatPrice(transactionFee)} ${feeToken} (~$${estimatedValueFee.toFixed(
                        2,
                    )})`}
                </div>
            </div>
