...
const TradePriceTable = (props) => {
    ...
    return (
        <Table
            ...
            isLeft={settings.stackOrderbook}
        >
            {props.head && (
                <thead>
                    <tr>
            ...
            <tbody>
                {props.priceTableData.map((d, i) => {
                    const color =
                        d.side === "b"
                            ? theme.colors.success400
                            : theme.colors.danger400;
                    if (props.className !== "trade_table_asks") {
                        total_step += d.td2;
                    }

                    const breakpoint = Math.round(
                        (total_step / total_total) * 100
                    );
                    let rowStyle;
                    ...
                    return (
                        ...
                        >
                            <td>
                                ...
                                >
                                    {addComma(
                                        Number(numStringToSymbol(amount, 2))
                                    )}
                                </Text>
                            </td>
                            <td>
