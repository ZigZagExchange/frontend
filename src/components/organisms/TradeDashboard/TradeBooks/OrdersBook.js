...
export default function OrdersBook(props) {
    ...
    let binsLength =
        askBins.length > bidBins.length ? bidBins.length : askBins.length;
    askBins = askBins.slice(0, binsLength);
    bidBins = bidBins.slice(0, binsLength);
                ...
                <BooksWrapper>
                    {settings.stackOrderbook ? (
                        <>
                            ...
                            {side === "sell" ? (
                                <>
                                    ...
                                    <TradePriceTable
                                        ...
                                        useGradient={
                                            !settings.disableOrderBookFlash
                                        }
                                        adClass="no-space"
                            ...
                            <Divider />
                            <OrderFooterWrapper
                                isStack={settings.stackOrderbook}
                            >
                                {/* <Dropdown
