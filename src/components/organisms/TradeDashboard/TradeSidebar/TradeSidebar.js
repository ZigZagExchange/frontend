...
import { liquiditySelector, balancesSelector } from 'lib/store/features/api/apiSlice';
...
const StyledTradeSidebar = styled.aside`
    ...
    background: ${({ theme, isDark }) =>
        isDark ? theme.colors.backgroundMediumEmphasis : theme.colors.backgroundHighEmphasis};
    // overflow-y: hidden;
