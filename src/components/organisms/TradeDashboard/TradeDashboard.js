...
import {getChainIdFromMarketChain, marketQueryParam, networkQueryParam} from "../../pages/ListPairPage/SuccessModal";
...
const TradeGrid = styled.article`
    ...
    @media screen and (max-width: 991px) {
      grid-template-rows: 50px 300px 3fr 2fr 2fr 50px;
