...
import { fetchFavourites, addFavourite, removeFavourite } from 'lib/helpers/storage/favourites';
...
const Divider = styled.div`
    ...
    background-color: ${({ theme, isDark }) =>
        isDark === 'false' ? theme.colors.backgroundMediumEmphasis : theme.colors.foreground400};
`;
