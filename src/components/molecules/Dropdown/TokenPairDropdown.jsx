...
const TokenPairDropdown = ({
    ...
    useMemo(() => {
        ...
        _.map(rowData, (each, i) => {
            if (each.td2 > rowData[i]?.td2) tmp.push({ td1: each.td1, increase: true });
            else if (each.td2 < rowData[i]?.td2) tmp.push({ td1: each.td1, increase: false });
            ...
            .map((d, i) => {
                ...
                return (
                    ...
                    >
                        ...
                        <td>
                            <Text font="tableContent" color="foregroundHighEmphasis" align="right">
