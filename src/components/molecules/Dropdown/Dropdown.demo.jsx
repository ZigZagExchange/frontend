  ...
  return (
    <>
        <Row>
            ...
            <Dropdown width ={242} item={data2} leftIcon context={context2} clickFunction={clickItem2}/>
            <Dropdown width ={242} item={data3} rightIcon context={context3} clickFunction={clickItem3}/>
            <AccountDropdown width ={242} item={data3} rightIcon clickFunction={clickItem4}/>
        </Row>
    </>
  );
};
