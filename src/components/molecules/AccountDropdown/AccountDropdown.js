...
export const AccountDropdown = () => {
    ...
    const explorer = address
        ? api.getExplorerAccountLink(network, address)
        : null;
    const networkName =
        selectedLayer === 1 ? "Etherscan" : api.getNetworkDisplayName(network);
                    ...
                    >
                        <LayoutList layout={selectedLayout}>
                            ...
                            <LayoutItem onClick={() => changeLayout(1)}>
                                <Tooltip
                                    placement={"bottom"}
                                    label={"Chart Focused Layout"}
                                >
                                    <img
                                        src={ThirdLayoutImage}
                                        alt="Chart Focused"
                                    />
                                </Tooltip>
                            </LayoutItem>
                            <LayoutItem onClick={() => changeLayout(2)}>
                                ...
                                >
                                    <img
                                        src={FourthLayoutImage}
                                        alt="Chart Focused RTL"
                                    />
                                </Tooltip>
                            </LayoutItem>
                            <LayoutItem onClick={() => changeLayout(3)}>
                                <Tooltip
                                    placement={"bottom"}
                                    label={"Default RTL Layout"}
                                >
                                    <img
                                        src={SecondLayoutImage}
                                        alt="Default RTL"
                                    />
                                </Tooltip>
                            </LayoutItem>
