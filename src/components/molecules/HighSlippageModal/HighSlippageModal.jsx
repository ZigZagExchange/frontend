...
import { highSlippageModalSelector, setHighSlippageModal } from 'lib/store/features/api/apiSlice';
...
const FormDialog = () => {
    ...
    const onChangeTextValue = (e) => {
        setConfirmed(e.currentTarget.value.toLocaleLowerCase() === 'confirm' ? true : false);
