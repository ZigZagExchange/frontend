                ...
                if (state.userFills[fillid]) {
                    ...
                    if (newstatus === 'f') {
                        ...
                        if (
                            ...
                            toast.dismiss('Order placed.');
                            toast.warning(
                                ({ closeToast }) => <FillCard closeToast={closeToast} fill={p} />,
                                {
                                    toastId: fillid,
...
export const lastPricesSelector = (state) => state.api.lastPrices[state.api.network];
...
export const balancesSelector = (state) => state.api.balances[makeScopeUser(state.api)] || {};
