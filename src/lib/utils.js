...
export function formatMillonAmount(floatNum) {
    ...
    if (floatNum >= 100000000 && floatNum < 1000000000) {
        floatNum /= 1000000;
        floatNum = floatNum.toFixed(2);
        return `${floatNum}M`;
    }
    if (floatNum >= 1000000000 && floatNum < 10000000000) {
        floatNum /= 1000000;
...
export function formatAmount(amount, currency) {
    return parseFloat(amount / 10 ** currency.decimals).toFixed(Math.min(5, currency.decimals));
}
