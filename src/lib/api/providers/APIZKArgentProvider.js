...
export default class APIZKArgentProvider extends APIZKProvider {
    ...
    submitOrder = async (market, side, price, amount, orderType) => {
        ...
        console.warn("marketInfo", marketInfo);
        console.warn("tokenRatio", tokenRatio);
    ...
    signIn = async () => {
        console.warn("signIn APIZKArgentProvider", this.api)
        try {
    ...
    isArgent = () => this.api.ethersProvider.provider.isArgent;
}
